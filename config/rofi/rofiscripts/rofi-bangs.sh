...
# open bookmarks
COMMANDS["bookmarks"]="~/.dotfiles/config/rofi/rofiscripts/rofi-surfraw-bookmarks.sh"
LABELS["bookmarks"]=""

# search local files
COMMANDS["locate"]="~/.dotfiles/config/rofi/rofiscripts/rofi-locate.sh"
LABELS["locate"]=""

# open custom web searches
COMMANDS["websearch"]="~/.dotfiles/config/rofi/rofiscripts/rofi-surfraw-websearch.sh"
LABELS["websearch"]=""
