...
# open bookmarks
COMMANDS["bookmarks"]="~/.dotfiles/rofi-scripts-collection/rofi-surfraw-bookmarks.sh"
LABELS["bookmarks"]=""

# search local files
COMMANDS["locate"]="~/.dotfiles/rofi-scripts-collection/rofi-locate.sh"
LABELS["locate"]=""

# open custom web searches
COMMANDS["websearch"]="~/.dotfiles/rofi-scripts-collection/rofi-surfraw-websearch.sh"
LABELS["websearch"]=""
