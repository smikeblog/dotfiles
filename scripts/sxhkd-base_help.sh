...
awk '/^[a-z]/ && last {print $0,"\t",last} {last=""} /^#/{last=$0}' ~/.dotfiles/config-sm/sxhkd/sxhkdrc-base | column -t -s $'\t'  | rofi -dmenu -i -no-show-icons -width 1000 -columns 1 -font "Noto Sans 9" lines 50
