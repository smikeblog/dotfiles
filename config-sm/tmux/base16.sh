...
tm_session_name="#[fg=$base0B]Session: #[fg=$tm_color_feature,bold]#S #[fg=yellow]#I #[fg=cyan]#P"
...
#set-option -g status-left "#[fg=green]Session: #[fg=$tm_color_feature,bold]#S #[fg=yellow]#I #[fg=cyan]#P"

#}}}

# tm_tunes="#[bg=$base00,fg=$base0D] ♫ #(~/.dotfiles/tmux/tunes.js)"
tm_tunes="#[bg=$base00,fg=$base0D] ♫ #(~/.dotfiles/tmux/tmux-mpd)"
# tm_tunes="#[fg=$tm_color_music]#(osascript ~/.dotfiles/applescripts/tunes.scpt | cut -c 1-50)"
# tm_`attery="#(~/.dotfiles/bin/battery_indicator,sh)"
